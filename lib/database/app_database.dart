...
class AppDatabase extends _$AppDatabase {
  ...
  Future<void> _seedData() async {
    ...
    final exercisesData = [
      ...
      _ExerciseSeed('Schulterpresse', 'Schulter', 'machine', 'shoulder', []),
      _ExerciseSeed('Seitheben', 'Schulter', 'cable', 'shoulder', []),
      _ExerciseSeed('Trizeps Skull Crush', 'Arme', 'free_weight', 'arm', ['Skullcrusher']),
      _ExerciseSeed('Trizeps Kabelzug', 'Arme', 'cable', 'arm', []),
      _ExerciseSeed('Latzug', 'Rücken', 'machine', 'pull_up', []),
      _ExerciseSeed('Rudern', 'Rücken', 'machine', 'rowing', []),
      _ExerciseSeed('Rudern Brustgestützt', 'Rücken', 'machine', 'rowing', []),
      _ExerciseSeed('Face Pulls', 'Schulter', 'cable', 'cable', []),
      _ExerciseSeed('Bizeps Hammer Curls', 'Arme', 'free_weight', 'arm', []),
      _ExerciseSeed('Bizeps Kabelzug', 'Arme', 'cable', 'arm', []),
      _ExerciseSeed('Hyperextension', 'Core', 'machine', 'core', []),
      _ExerciseSeed('Bauch', 'Core', 'machine', 'core', []),
      _ExerciseSeed('Bauchmaschine', 'Core', 'machine', 'core', []),
      _ExerciseSeed('Unterarm-Innencurls', 'Unterarme', 'free_weight', 'arm', []),
      _ExerciseSeed('Unterarm-Außencurls', 'Unterarme', 'free_weight', 'arm', []),
    ];
